...
public class DataVerticleMigrationTest {
    ...
    void tearDown(Vertx vertx, VertxTestContext testContext) {
        Future<Void> close = DataVerticle.pool == null
                ? Future.succeededFuture()
                : DataVerticle.pool.close();
        close.compose(_ -> DataVerticleTest.clear(vertx))
                .onComplete(v -> {
                    if (v.failed()) {
